...
const Home = () => {
  ...
  return (
    <section id="home" className="bg-slate-300 h-screen flex flex-col justify-center items-center">
      ...
      <button onClick={signupHandler} className="bg-blue-600 font-bold text-white px-6 py-3 rounded-full">Sign up</button>
      <button className="bg-blue-600 font-bold text-white px-6 py-3 rounded-full">Sign in</button>
      </div>
